...
C
c$$$      PROGRAM fitest
c$$$      IMPLICIT CHARACTER (A-Z)
c$$$C
c$$$      INTEGER n
c$$$      DOUBLEPRECISION angle
c$$$      DOUBLEPRECISION pert
c$$$      PARAMETER (n = 401)
c$$$      PARAMETER (angle = 1.0D0)
c$$$      PARAMETER (pert = 0.2D0)
c$$$C
c$$$      DOUBLEPRECISION y (3, n)
c$$$      DOUBLEPRECISION x (3, n)
c$$$      DOUBLEPRECISION z (3, n)
c$$$      DOUBLEPRECISION w (n)
c$$$      DOUBLEPRECISION o (3)
c$$$      DOUBLEPRECISION q (4)
c$$$      DOUBLEPRECISION u (3, 3)
c$$$      INTEGER ierr
c$$$C
c$$$C seed the random number generator
c$$$C call ranini for vax
c$$$C
c$$$      CALL ranset (123571)
c$$$*     CALL ranini ()
c$$$C
c$$$C generate reference and test molecules and weights
c$$$C
c$$$      CALL genxyw (angle, pert, n, x, y, w)
c$$$      CALL center (n, y, w, .FALSE., o, o)
c$$$      CALL center (n, x, w, .FALSE., o, o)
c$$$      CALL identm (3, 3, u)
c$$$      CALL analyz (n, x, y, w, u)
c$$$C
c$$$C fit x to y
c$$$C
c$$$      WRITE (*, *)
c$$$      WRITE (*, *) 'fitting x to y'
c$$$      CALL qtrfit (n, x, y, w, q, u, ierr)
c$$$      CALL rotmol (n, x, z, u)
c$$$      CALL analyz (n, z, y, w, u)
c$$$C
c$$$C fit y to x
c$$$C
c$$$      WRITE (*, *)
c$$$      WRITE (*, *) 'fitting y to x'
c$$$      CALL qtrfit (n, y, x, w, q, u, ierr)
c$$$      CALL rotmol (n, y, z, u)
c$$$      CALL analyz (n, z, x, w, u)
c$$$C
c$$$      END
c$$$C
C GENROT
